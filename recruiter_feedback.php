...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($conn->query($sql) === True){
        header("Location: recruiter_feedback.php"); // Replace with the actual page name
   ...
   <div id="preloader-active">
    ...
    <!-- Hero Area Start-->
        ...
        <main class="ml-5 mr-5 mt-5 mb-5">
            <div class="mb-5">
                ...
                <tbody>
                    <?php
                        ...
                        $total_feedback_query = "SELECT COUNT(*) as total FROM feedback WHERE user_type = 'Recruiter'";
                        $total_feedback_result = $conn->query($total_feedback_query);
                        $total_feedback = $total_feedback_result->fetch_assoc()['total'];
                        
                        // Calculate total pages
                        $total_pages = ceil($total_feedback / $items_per_page);
                        
                        // Fetch feedback for the current page
                        $sql = "SELECT * FROM feedback WHERE user_type = 'Recruiter' LIMIT $items_per_page OFFSET $offset";
                    ...
                    <tr>
                        ...
                        <td>
                        <form action="recruiter_feedback.php" method="POST" style="display:inline;">
            ...
            <?php if ($total_feedback > $items_per_page): ?>
